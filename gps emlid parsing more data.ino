...
String secondValue, thirdValue, fourthValue, fifthValue, sixthValue, seventhValue, firstValue;
...
void serialEvent1() {
  ...
  if (Serial1.available() > 0){
    ...
    if (String(a) == ":"){      
      ...
      seventhValue = myString.substring(Index6+1, Index7);
      
      firstValue = myString.substring(Index7+1, Index8);
      ...
      longitude = fifthValue.toFloat();
      Serial.print("longitude:");Serial.println(longitude,5);
     
      Serial.print("1:");Serial.println(firstValue.toFloat());
      Serial.print("2:");Serial.println(secondValue.toFloat());
      ...
      Serial.print("7:");Serial.println(seventhValue.toFloat());
